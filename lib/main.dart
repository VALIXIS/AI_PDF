...
ThemeData get lightTheme => ThemeData(
  ...
  textTheme: const TextTheme(
    headlineLarge:  TextStyle(color: kTextLight, fontWeight: FontWeight.w800),
    headlineMedium: TextStyle(color: kTextLight, fontWeight: FontWeight.w700),
    headlineSmall:  TextStyle(color: kTextLight, fontWeight: FontWeight.w700),
...
ThemeData get darkTheme => ThemeData(
  ...
  textTheme: const TextTheme(
    ...
    headlineMedium: TextStyle(color: kTextDark, fontWeight: FontWeight.w700),
